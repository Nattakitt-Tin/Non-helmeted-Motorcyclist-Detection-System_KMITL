...
path_file = "C:/Users/59010401/Desktop/extracted"
...
class Person:
    ...
    def saveImg(self, frame, x, y, w, h):
        if not self.isSaved and self.direction == -1: # is up
            global img_num
            global current_video,path_file
            ...
            for result in t3:
                if result[1] == 'motor_scooter' and result[2] > 0.1:
                    ...
                    result_path = "C:/Users/59010401/Desktop/extracted"+"/helmet/bike_"+str(img_num)+"_"+str(current_video)+".jpg"
                    if helmet > 0.5: #helmet
                        img_flip = cv2.flip(img, 1)
                        preds_flip = helmet_model.predict([[img_flip]])
                        helmet_flip = preds_flip[0][1]
                        if helmet_flip > 0.5: #helmet
                            result_path = "C:/Users/59010401/Desktop/extracted"+"/no_helmet/bike_"+str(img_num)+"_"+str(current_video)+".jpg"
...
def main(video_name_list, bike_h, max_speed_ratio, show=True, real_fps=False):
    global current_video, progress, crop ,num1,num2,num3,num4,path_file

    left,right,top,bottom = num1,num2,num3,num4
    cv2.namedWindow("BGR")
